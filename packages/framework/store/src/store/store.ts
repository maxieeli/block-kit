import { type Logger, NoopLogger } from '@maxiee/block_global/utils';
import {
  AwarenessEngine,
...
import { BlockKitDoc } from '../yjs/index.js';
...
export interface StoreOptions<
  Flags extends Record<string, unknown> = BlockKitFlags,
> {
  id?: string;
...
const FLAGS_PRESET = {
  ...
  readonly: {},
} satisfies BlockKitFlags;

export class Store {
  readonly id: string;

  readonly doc: BlockKitDoc;
  ...
  constructor(
    ...
    this.id = id || '';
    this.doc = new BlockKitDoc({ guid: id });
