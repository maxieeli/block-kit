import { assertExists, DisposableGroup, Slot } from '@maxiee/block_global/utils';
...
export class BlockIndexer {
  private readonly _doc: BlockKitDoc;
    ...
    events.forEach(e => {
      ...
      if (e instanceof YMapEvent) {
        if (e.target !== e.currentTarget) {
          // add 'elements' to 'workbench:surface' or add 'prop:xywh' to 'workbench:note'
