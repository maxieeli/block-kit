...
import type { BaseTextAttributes, DeltaInsert } from '@maxiee/block_inline';
...
/**
 * Please sync type with {@link WorkbenchTextAttributes} manually
 */
    ...
    switch (action) {
      ...
      case 'update': {
        ...
        if (
          ...
          flavour === 'workbench:embed-synced-doc'
        ) {
