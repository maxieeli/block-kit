...
export const DEFAULT_DB_NAME = 'blockkit-local';
...
interface BlockKitBinaryDB extends DBSchema {
  collection: {
    key: string;
...
export function upgradeDB(db: IDBPDatabase<BlockKitBinaryDB>) {
...
export class IndexedDBDocSource implements DocSource {
  ...
  dbPromise: Promise<IDBPDatabase<BlockKitBinaryDB>> | null = null;
  ...
  getDb() {
    if (this.dbPromise === null) {
      this.dbPromise = openDB<BlockKitBinaryDB>(this.dbName, dbVersion, {
        upgrade: upgradeDB,
      });
    }
