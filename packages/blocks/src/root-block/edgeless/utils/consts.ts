...
export const NOTE_OVERLAY_STOKE_COLOR = '--workbench-border-color';
export const NOTE_OVERLAY_TEXT_COLOR = '--workbench-icon-color';
...
export const DEFAULT_NOTE_CHILD_FLAVOUR = 'workbench:paragraph';
...
export const SHAPE_TEXT_COLOR_PURE_WHITE = '--workbench-palette-line-white';
export const SHAPE_TEXT_COLOR_PURE_BLACK = '--workbench-palette-line-black';
export const SHAPE_FILL_COLOR_BLACK = '--workbench-palette-shape-black';
