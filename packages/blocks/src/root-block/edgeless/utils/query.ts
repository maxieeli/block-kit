...
export function isMindmapNode(
  element: EdgelessBlockModel | BlockKit.EdgelessModelType | null
) {
  return element?.group instanceof MindmapElementModel;
}

export function isTopLevelBlock(
  selectable: BlockModel | BlockKit.EdgelessModelType | BlockModel | null
): selectable is EdgelessBlockModel {
  return !!selectable && 'flavour' in selectable;
}

export function isNoteBlock(
  element: BlockModel | BlockKit.EdgelessModelType | null
): element is NoteBlockModel {
  return !!element && 'flavour' in element && element.flavour === 'workbench:note';
}
...
export function isEdgelessTextBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'workbench:edgeless-text'
  );
}
...
export function isFrameBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'workbench:frame'
  );
}
...
export function isImageBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'workbench:image'
  );
}
...
export function isAttachmentBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'workbench:attachment'
  );
}
...
export function isBookmarkBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'workbench:bookmark'
  );
}
...
export function isEmbeddedBlock(
  ...
  return (
    !!element && 'flavour' in element && /workbench:embed-*/.test(element.flavour)
  );
}
...
export function isEmbedGithubBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'workbench:embed-github'
  );
}
...
export function isEmbedYoutubeBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'workbench:embed-youtube'
  );
}
...
export function isEmbedLoomBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'workbench:embed-loom'
  );
}
...
export function isEmbedFigmaBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'workbench:embed-figma'
  );
}
...
export function isEmbedLinkedDocBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'workbench:embed-linked-doc'
  );
}
...
export function isEmbedSyncedDocBlock(
  ...
  return (
    !!element &&
    'flavour' in element &&
    element.flavour === 'workbench:embed-synced-doc'
  );
}
...
export function isEmbedHtmlBlock(
  ...
  return (
    !!element && 'flavour' in element && element.flavour === 'workbench:embed-html'
  );
}

export function isCanvasElement(
  selectable: BlockKit.EdgelessModelType | null
): selectable is BlockKit.SurfaceModelType {
...
export function isConnectable(
  element: BlockKit.EdgelessModelType | null
...
export function getBackgroundGrid(zoom: number, showGrid: boolean) {
  ...
  return {
    gap,
    grid: showGrid
      ? 'radial-gradient(var(--workbench-edgeless-grid-color) 1px, var(--workbench-background-primary-color) 1px)'
      : 'unset',
  };
}

export function getSelectedRect(
  selected: BlockKit.EdgelessModelType[]
): DOMRect {
