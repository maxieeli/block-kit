...
import { assertType, type Disposable, Slot } from '@maxiee/block_global/utils';
...
export class EdgelessSelectedRect extends WithDisposable(LitElement) {
  ...
  get resizeMode(): ResizeMode {
    ...
    for (const element of elements) {
      if (isNoteBlock(element) || isEmbedSyncedDocBlock(element)) {
        ...
        assertType<BlockKit.SurfaceElementModelType>(element);
  ...
  static override styles = css`
    ...
    .workbench-edgeless-selected-rect {
      position: absolute;
      top: 0;
      left: 0;
      ...
      border-width: var(--workbench-border-width);
      border-style: solid;
      transform: translate(0, 0) rotate(0);
    }

    .workbench-edgeless-selected-rect .handle {
      position: absolute;
      user-select: none;
      outline: none;
      pointer-events: auto;
    ...
    .workbench-edgeless-selected-rect .handle[aria-label^='top-'],
    .workbench-edgeless-selected-rect .handle[aria-label^='bottom-'] {
      width: 18px;
      height: 18px;
      box-sizing: border-box;
      z-index: 10;
    ...
    .workbench-edgeless-selected-rect .handle[aria-label^='top-'] .resize,
    .workbench-edgeless-selected-rect .handle[aria-label^='bottom-'] .resize {
      position: absolute;
      width: 12px;
      height: 12px;
      box-sizing: border-box;
      border-radius: 50%;
      border: 2px var(--workbench-blue) solid;
      background: white;
    }

    .workbench-edgeless-selected-rect .handle[aria-label^='top-'] .rotate,
    .workbench-edgeless-selected-rect .handle[aria-label^='bottom-'] .rotate {
      position: absolute;
      width: 12px;
      height: 12px;
      box-sizing: border-box;
    ...
    /* -18 + 6.5 */
    .workbench-edgeless-selected-rect .handle[aria-label='top-left'] {
      left: -12px;
      top: -12px;
    }
    .workbench-edgeless-selected-rect .handle[aria-label='top-left'] .resize {
      right: 0;
      bottom: 0;
    }
    .workbench-edgeless-selected-rect .handle[aria-label='top-left'] .rotate {
      right: 6px;
      bottom: 6px;
    }

    .workbench-edgeless-selected-rect .handle[aria-label='top-right'] {
      top: -12px;
      right: -12px;
    }
    .workbench-edgeless-selected-rect .handle[aria-label='top-right'] .resize {
      left: 0;
      bottom: 0;
    }
    .workbench-edgeless-selected-rect .handle[aria-label='top-right'] .rotate {
      left: 6px;
      bottom: 6px;
    }

    .workbench-edgeless-selected-rect .handle[aria-label='bottom-right'] {
      right: -12px;
      bottom: -12px;
    }
    .workbench-edgeless-selected-rect .handle[aria-label='bottom-right'] .resize {
      left: 0;
      top: 0;
    }
    .workbench-edgeless-selected-rect .handle[aria-label='bottom-right'] .rotate {
      left: 6px;
      top: 6px;
    }

    .workbench-edgeless-selected-rect .handle[aria-label='bottom-left'] {
      bottom: -12px;
      left: -12px;
    }
    .workbench-edgeless-selected-rect .handle[aria-label='bottom-left'] .resize {
      right: 0;
      top: 0;
    }
    .workbench-edgeless-selected-rect .handle[aria-label='bottom-left'] .rotate {
      right: 6px;
      top: 6px;
    }
    ...
    .workbench-edgeless-selected-rect .handle[aria-label='top'],
    .workbench-edgeless-selected-rect .handle[aria-label='bottom'],
    .workbench-edgeless-selected-rect .handle[aria-label='left'],
    .workbench-edgeless-selected-rect .handle[aria-label='right'] {
      border: 0;
      background: transparent;
      border-color: var('--workbench-blue');
    }
    ...
    .workbench-edgeless-selected-rect .handle[aria-label='top'] .resize,
    .workbench-edgeless-selected-rect .handle[aria-label='bottom'] .resize,
    .workbench-edgeless-selected-rect .handle[aria-label='left'] .resize,
    .workbench-edgeless-selected-rect .handle[aria-label='right'] .resize {
      width: 100%;
      height: 100%;
    }

    .workbench-edgeless-selected-rect .handle[aria-label='top'] .resize:after,
    .workbench-edgeless-selected-rect .handle[aria-label='bottom'] .resize:after,
    .workbench-edgeless-selected-rect .handle[aria-label='left'] .resize:after,
    .workbench-edgeless-selected-rect .handle[aria-label='right'] .resize:after {
      position: absolute;
      width: 7px;
      height: 7px;
      box-sizing: border-box;
    ...
    .workbench-edgeless-selected-rect .handle .resize::before {
      content: '';
      display: none;
      position: absolute;
      width: 20px;
    ...
    .workbench-edgeless-selected-rect[data-mode='scale']
      .handle[aria-label='top-left']
      .resize:hover::before,
    .workbench-edgeless-selected-rect[data-scale-direction='top-left'][data-scale-percent]
      .handle[aria-label='top-left']
      .resize::before {
      display: block;
      top: 0px;
    ...
    .workbench-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .workbench-edgeless-selected-rect[data-scale-direction='top-right'][data-scale-percent]
      .handle[aria-label='top-right']
      .resize::before {
      display: block;
      top: 0px;
    ...
    .workbench-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .workbench-edgeless-selected-rect[data-scale-direction='bottom-right'][data-scale-percent]
      .handle[aria-label='bottom-right']
      .resize::before {
      display: block;
      bottom: 0px;
    ...
    .workbench-edgeless-selected-rect[data-mode='scale']
      ...
      .resize:hover::before,
    .workbench-edgeless-selected-rect[data-scale-direction='bottom-left'][data-scale-percent]
      .handle[aria-label='bottom-left']
      .resize::before {
      display: block;
      bottom: 0px;
    ...
    .workbench-edgeless-selected-rect::after {
    ...
    .workbench-edgeless-selected-rect[data-scale-direction='top-left']::after {
      display: block;
      top: -20px;
      left: -20px;
      transform: translate(-100%, -100%);
    }
    .workbench-edgeless-selected-rect[data-scale-direction='top-right']::after {
      display: block;
      top: -20px;
      right: -20px;
      transform: translate(100%, -100%);
    }
    .workbench-edgeless-selected-rect[data-scale-direction='bottom-right']::after {
      display: block;
      bottom: -20px;
      right: -20px;
      transform: translate(100%, 100%);
    }
    .workbench-edgeless-selected-rect[data-scale-direction='bottom-left']::after {
      display: block;
      bottom: -20px;
      left: -20px;
      transform: translate(-100%, 100%);
  ...
  private _isProportionalElement(element: BlockKit.EdgelessModelType) {
    return (
  ...
  private _shouldRenderSelection(elements?: BlockKit.EdgelessModelType[]) {
  ...
  #adjustProportional(
    element: BlockKit.EdgelessModelType,
    bound: Bound,
    direction: HandleDirection
  ) {
    const curBound = Bound.deserialize(element.xywh);
  ...
  override render() {
    ...
    return html`
      <style>
        .workbench-edgeless-selected-rect .handle[aria-label='right']::after {
          content: '';
          ...
          width: 2px;
          height: 100%;
          background: var(--workbench-error-color);
          filter: drop-shadow(-6px 0px 12px rgba(235, 67, 53, 0.35));
        }

        .workbench-edgeless-selected-rect .handle[aria-label='bottom']::after {
          content: '';
      ...
      <div
        class="workbench-edgeless-selected-rect"
        style=${styleMap({
