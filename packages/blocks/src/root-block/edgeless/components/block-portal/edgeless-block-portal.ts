...
const portalMap = new Map<BlockKit.EdgelessModelKeyType | RegExp, string>([
  ['workbench:frame', 'edgeless-block-portal-frame'],
  ['workbench:note', 'edgeless-block-portal-note'],
  ['workbench:image', 'edgeless-block-portal-image'],
  ['workbench:bookmark', 'edgeless-block-portal-bookmark'],
  ['workbench:attachment', 'edgeless-block-portal-attachment'],
  ['workbench:edgeless-text', 'edgeless-block-portal-edgeless-text'],
  [/workbench:embed-*/, 'edgeless-block-portal-embed'],
]);
...
export class EdgelessBlockPortalContainer extends WithDisposable(
  ...
  static override styles = css`
    .workbench-block-children-container.edgeless {
      user-select: none;
    }
    ...
    .workbench-edgeless-layer > [data-portal-block-id] {
      display: none;
      position: relative;
    }
  `;
  ...
  getPortalElement(id: string) {
    ...
    ) as EdgelessPortalBase<BlockKit.EdgelessBlockModelType> | null;
  }
  ...
  override render() {
    ...
    return html`
      <div class="workbench-block-children-container edgeless">
        <div
          class="workbench-edgeless-layer"
          data-scale="${zoom}"
          data-translate="true"
        >
          ...
          ${layers
            ...
            .map(layer => {
              const elements =
                layer.elements as BlockKit.EdgelessBlockModelType[];
