...
export class EdgelessNoteSeniorButton extends EdgelessToolbarToolMixin(
  ...
  static override styles = css`
    ...
    .note-root {
      --paper-border-color: var(--workbench-pure-white);
    ...
    .note-root[data-dark='true'] {
      --paper-border-color: var(--workbench-divider-color);
  ...
  override type = 'workbench:note' as const;

  override enableActiveBackground = true;

  // TODO: better to extract these states outside of component?
  @state()
  accessor childFlavour: NoteTool['childFlavour'] = 'workbench:paragraph';
