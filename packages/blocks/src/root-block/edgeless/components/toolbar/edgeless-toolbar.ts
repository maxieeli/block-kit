...
import { debounce } from '@maxiee/block_global/utils';
  ...
  private _renderContent() {
    return html`
      ...
      <div class="quick-tool-more">
        ...
        >
          ${MoreHorizontalIcon}
          <workbench-tooltip tip-position="top" .offset=${25}>
            More Tools
          </workbench-tooltip>
        </icon-button>
      </div>
        ...
        >
          ...
          ${cache(
            this._seniorPrevTooltip
              ? html` <workbench-tooltip tip-position="top" .offset=${4}>
                  ${this._seniorPrevTooltip}
                </workbench-tooltip>`
              : nothing
          )}
    ...
    return html`
      ...
      >
        <smooth-corner
          ...
          .smooth=${0.7}
          .borderWidth=${1}
          .bgColor=${'var(--workbench-background-overlay-panel-color)'}
          .borderColor=${'var(--workbench-border-color)'}
