...
function countByField<K extends keyof TextStyleProps>(
  elements: BlockKit.EdgelessTextModelType[],
  field: K
) {
...
function extractField<K extends keyof TextStyleProps>(
  element: BlockKit.EdgelessTextModelType,
  field: K
) {
...
export class EdgelessChangeTextMenu extends WithDisposable(LitElement) {
  ...
  accessor elements!: BlockKit.EdgelessTextModelType[];

  @property({ attribute: false })
  accessor elementType!: BlockKit.EdgelessTextModelKeyType;
  ...
  private _updateElementBound = (element: BlockKit.EdgelessTextModelType) => {
