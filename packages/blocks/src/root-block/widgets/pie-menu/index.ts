...
export const WORKBENCH_PIE_MENU_WIDGET = 'workbench-pie-menu-widget';

@customElement(WORKBENCH_PIE_MENU_WIDGET)
export class WorkbenchPieMenuWidget extends WidgetElement {
  get isOpen() {
  ...
  get rootElement(): EdgelessRootBlockComponent {
    ...
    throw new Error('WorkbenchPieMenuWidget is only supported in edgeless');
  }
  ...
  _createMenu(
    schema: PieMenuSchema,
    {
      ...
      x: number;
      y: number;
      widgetElement: WorkbenchPieMenuWidget;
    }
  ) {
...
declare global {
  interface HTMLElementTagNameMap {
    [WORKBENCH_PIE_MENU_WIDGET]: WorkbenchPieMenuWidget;
  }
}
