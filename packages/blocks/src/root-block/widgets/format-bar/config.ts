import type { Chain, InitCommandCtx } from '@maxiee/block-std';
...
import type { WorkbenchFormatBarWidget } from './format-bar.js';
...
export type InlineActionConfigItem = {
  ...
  action: (
    ...
    formatBar: WorkbenchFormatBarWidget
  ) => void;
...
export type CustomConfigItem = {
  type: 'custom';
  render: (formatBar: WorkbenchFormatBarWidget) => TemplateResult | null;
};
...
export function toolbarDefaultConfig(toolbar: WorkbenchFormatBarWidget) {
  toolbar
    .clearConfig()
