...
export const WORKBENCH_DOC_REMOTE_SELECTION_WIDGET =
  'workbench-doc-remote-selection-widget';

@customElement(WORKBENCH_DOC_REMOTE_SELECTION_WIDGET)
export class WorkbenchDocRemoteSelectionWidget extends WidgetElement {
...
declare global {
  interface HTMLElementTagNameMap {
    [WORKBENCH_DOC_REMOTE_SELECTION_WIDGET]: WorkbenchDocRemoteSelectionWidget;
  }
}
