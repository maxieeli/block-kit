import type { EditorHost, UIEventStateContext } from '@maxiee/block-std';
...
import { InlineEditor } from '@maxiee/block_inline';
import { customElement } from 'lit/decorators.js';

import type { WorkbenchInlineEditor } from '../../../_common/inline/presets/workbench-inline-specs.js';
...
export const WORKBENCH_LINKED_DOC_WIDGET = 'workbench-linked-doc-widget';

@customElement(WORKBENCH_LINKED_DOC_WIDGET)
export class WorkbenchLinkedDocWidget extends WidgetElement {
  ...
  options = WorkbenchLinkedDocWidget.DEFAULT_OPTIONS;
  ...
  showLinkedDoc = (inlineEditor: WorkbenchInlineEditor, triggerKey: string) => {
...
declare global {
  interface HTMLElementTagNameMap {
    [WORKBENCH_LINKED_DOC_WIDGET]: WorkbenchLinkedDocWidget;
  }
}
