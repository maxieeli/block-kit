...
@customElement('workbench-custom-modal')
export class WorkbenchCustomModal extends LitElement {
  static override styles = css`
    :host {
      z-index: calc(var(--workbench-z-index-modal) + 3);
      position: fixed;
      top: 0;
      left: 0;
      width: 100vw;
    ...
    .modal-background {
      ...
      align-items: center;
      background-color: var(--workbench-background-modal-color);
    ...
    .modal-footer .primary {
      ...
      border-color: var(--workbench-black-10);
      box-shadow: var(--workbench-button-inner-shadow);
...
export function createCustomModal(
  ...
  const modal = new WorkbenchCustomModal();
