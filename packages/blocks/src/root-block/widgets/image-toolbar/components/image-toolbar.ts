...
@customElement('workbench-image-toolbar')
export class WorkbenchImageToolbar extends LitElement {
  get _items() {
  ...
  override render() {
    return html`
      <div
        class="workbench-image-toolbar-container"
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-image-toolbar': WorkbenchImageToolbar;
  }
}
