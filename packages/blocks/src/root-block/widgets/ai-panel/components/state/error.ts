...
export class AIPanelError extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .error {
      ...
      .error-info {
        align-self: stretch;
        color: var(--workbench-error-color, #eb4335);
    ...
    .response-list-container ai-item-list {
      --item-padding: 4px;
      --item-icon-color: var(--workbench-icon-secondary);
      --item-icon-hover-color: var(--workbench-icon-color);
    }
  `;
