...
export const WORKBENCH_CODE_TOOLBAR_WIDGET = 'workbench-code-toolbar-widget';
@customElement(WORKBENCH_CODE_TOOLBAR_WIDGET)
export class WorkbenchCodeToolbarWidget extends WidgetElement<
  CodeBlockModel,
  CodeBlockComponent
> {
  ...
  private _setHoverController = () => {
    ...
    this._hoverController = new HoverController(
      ...
      ({ abortController }) => {
        ...
        return {
          template: html`<workbench-code-toolbar
...
declare global {
  interface HTMLElementTagNameMap {
    [WORKBENCH_CODE_TOOLBAR_WIDGET]: WorkbenchCodeToolbarWidget;
  }
}
