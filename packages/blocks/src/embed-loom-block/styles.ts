...
export const styles = css`
  ...
  .workbench-embed-loom-video {
    width: 100%;
    height: 100%;
    opacity: var(--add, 1);
  }

  .workbench-embed-loom-video img,
  .workbench-embed-loom-video object,
  .workbench-embed-loom-video svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
  ...
  .workbench-embed-loom-video-iframe-container {
    position: relative;
  }

  .workbench-embed-loom-video-iframe-container > iframe {
    width: 100%;
    height: 410px;
    border-radius: 4px 4px var(--1, 0px) var(--1, 0px);
  }

  .workbench-embed-loom-video-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .workbench-embed-loom-video-iframe-overlay.hide {
    display: none;
  }

  .workbench-embed-loom-content {
    display: flex;
    flex-direction: column;
    width: 100%;
    height: 100%;
  ...
  .workbench-embed-loom-content-header {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .workbench-embed-loom-content-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .workbench-embed-loom-content-title-icon img,
  .workbench-embed-loom-content-title-icon object,
  .workbench-embed-loom-content-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--workbench-background-primary-color);
  }

  .workbench-embed-loom-content-title-text {
    flex: 1 0 0;
  ...
  .workbench-embed-loom-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .workbench-embed-loom-content-url {
    display: flex;
    align-items: center;
  ...
  .workbench-embed-loom-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .workbench-embed-loom-content-url:hover > span {
    color: var(--workbench-link-color);
  }
  .workbench-embed-loom-content-url:hover .open-icon {
    fill: var(--workbench-link-color);
  }

  .workbench-embed-loom-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .workbench-embed-loom-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--workbench-text-secondary-color);
  }

  .workbench-embed-loom-block.loading {
    .workbench-embed-loom-content-title-text {
      color: var(--workbench-placeholder-color);
    }
  }

  .workbench-embed-loom-block.selected {
    .workbench-embed-loom-content-url > span {
      color: var(--workbench-link-color);
    }
    .workbench-embed-loom-content-url .open-icon {
      fill: var(--workbench-link-color);
    }
  }
`;
