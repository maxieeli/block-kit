...
import { DisposableGroup } from '@maxiee/block_global/utils';
...
> extends SurfaceElementModel<Props> {
  ...
  hasChild(element: string | BlockKit.EdgelessModelType) {
    return (
   ...
   */
  hasDescendant(element: string | BlockKit.EdgelessModelType) {
