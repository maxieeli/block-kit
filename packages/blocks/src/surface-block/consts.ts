...
export enum FontFamily {
  Inter = 'blockkit:surface:Inter',
  Kalam = 'blockkit:surface:Kalam',
  Satoshi = 'blockkit:surface:Satoshi',
  Poppins = 'blockkit:surface:Poppins',
  Lora = 'blockkit:surface:Lora',
  BebasNeue = 'blockkit:surface:BebasNeue',
  OrelegaOne = 'blockkit:surface:OrelegaOne',
}
