...
function rangeFromElement<T extends BlockKit.EdgelessModelType>(
  ele: T
): number[] {
...
function rangeFromElementExternal<T extends BlockKit.EdgelessModelType>(
  ele: T
): number[] | null {
...
export class GridManager<T extends BlockKit.EdgelessModelType> {
  get isEmpty() {
