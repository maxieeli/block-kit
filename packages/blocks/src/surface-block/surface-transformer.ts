...
import { BaseBlockTransformer, DocCollection } from '@maxiee/block_store';

import type { SurfaceBlockProps } from './surface-model.js';

const SURFACE_TEXT_UNIQ_IDENTIFIER = 'workbench:surface:text';
// Used for group children field
const SURFACE_YMAP_UNIQ_IDENTIFIER = 'workbench:surface:ymap';
