...
import { BlockElement, RangeManager } from '@maxiee/block-std';
...
@customElement('workbench-surface')
...
> {
  ...
  static override styles = css`
    .workbench-edgeless-surface-block-container {
      position: absolute;
      width: 100%;
      height: 100%;
    }

    .workbench-edgeless-surface-block-container canvas {
      width: 100%;
      height: 100%;
      position: relative;
      z-index: 1;
    ...
    .workbench-edgeless-block-child {
      position: absolute;
      transform-origin: center;
      box-sizing: border-box;
      border: 2px solid var(--workbench-white-10);
      border-radius: 8px;
      box-shadow: var(--workbench-shadow-3);
      pointer-events: all;
    }
  `;
  ...
  @query('.workbench-edgeless-surface-block-container')
  ...
  override render() {
    ...
    return html`
      <div class="workbench-edgeless-surface-block-container">
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-surface': SurfaceBlockComponent;
  }
}
