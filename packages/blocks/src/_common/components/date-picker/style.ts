...
export const datePickerStyle = css`
  ...
  .date-picker-small-action:hover {
    color: var(--workbench-icon-hover-color);
    background: var(--workbench-icon-hover-background);
  }
  ...
  .interactive::before {
    opacity: 0;
    transition: none;
    box-shadow: 0 0 0 3px var(--workbench-primary-color);
  }
  /* .interactive:active, */
  .interactive:focus-visible {
    outline: none;
    outline: 1px solid var(--workbench-primary-color);
  }
