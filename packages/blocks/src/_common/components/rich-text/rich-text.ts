...
} from '../../inline/presets/workbench-inline-specs.js';
...
export class RichText extends WithDisposable(ShadowlessElement) {
  ...
  private _inlineEditor: WorkbenchInlineEditor | null = null;
  ...
  private _init() {
    ...
    // init inline editor
    this._inlineEditor = new InlineEditor<WorkbenchTextAttributes>(this._yText, {
