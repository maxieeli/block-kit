...
const autoIdentifyLink = (ctx: HookContext<WorkbenchTextAttributes>) => {
...
function handleExtendedAttributes(
  ctx:
    | BeforeinputHookCtx<WorkbenchTextAttributes>
    | CompositionEndHookCtx<WorkbenchTextAttributes>
) {
...
export const onVBeforeinput = (
  ctx: BeforeinputHookCtx<WorkbenchTextAttributes>
) => {
...
export const onVCompositionEnd = (
  ctx: CompositionEndHookCtx<WorkbenchTextAttributes>
) => {
  handleExtendedAttributes(ctx);
};
