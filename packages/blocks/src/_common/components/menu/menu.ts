...
export class MenuComponent<_T> extends WithDisposable(ShadowlessElement) {
  ...
  static override styles = css`
    ...
    .workbench-menu-header input::placeholder {
      color: var(--workbench-placeholder-color);
    }

    .workbench-menu-header input:focus {
      border: 1px solid var(--workbench-primary-color);
    }

    .workbench-menu-action {
      padding: 4px 12px;
      cursor: pointer;
      display: flex;
      gap: 4px;
    ...
    .workbench-menu-action .icon {
      display: flex;
      align-items: center;
      justify-content: center;
    }

    .workbench-menu-action .content {
      border-radius: 4px;
      cursor: pointer;
      white-space: nowrap;
    ...
    .workbench-menu-action.selected {
      background-color: var(--workbench-hover-color);
    }

    .workbench-menu-action.selected.delete-item {
      background-color: var(--workbench-background-error-color);
      color: var(--workbench-error-color);
    }

    .workbench-menu-action.selected.delete-item .icon > svg {
      color: var(--workbench-error-color);
    }

    .workbench-menu-action.selected-item {
      color: var(--workbench-text-emphasis-color);
    }

    .workbench-menu-action.selected-item svg {
      color: var(--workbench-text-emphasis-color);
      fill: currentColor;
    }
      ...
      return [
        {
          ...
          label: html`
            ${icon}
            <div class="workbench-menu-action-text">
      ...
      >
        ...
        <div class="workbench-menu-body">
          ...
          ${repeat(this.allItems, (menu, index) => {
            ...
            const itemClass = menu.class || 'workbench-menu-item';
            const classes = classMap({
              'workbench-menu-action': true,
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-menu': MenuComponent<unknown>;
  }
}
...
export const createModal = (container: HTMLElement = document.body) => {
  ...
  div.style.fontFamily = 'var(--workbench-font-family)';
