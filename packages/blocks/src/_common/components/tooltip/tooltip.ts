...
const styles = css`
  .workbench-tooltip {
    ...
    background: var(--workbench-tooltip);
...
const triangleMap = {
  top: {
    ...
    borderColor: 'var(--workbench-tooltip) transparent transparent transparent',
  },
  right: {
    left: '-6px',
    borderStyle: 'solid',
    borderWidth: '5px 6px 5px 0',
    borderColor: 'transparent var(--workbench-tooltip) transparent transparent',
  },
  bottom: {
    top: '-6px',
    borderStyle: 'solid',
    borderWidth: '0 5px 6px 5px',
    borderColor: 'transparent transparent var(--workbench-tooltip) transparent',
  },
  left: {
    right: '-6px',
    borderStyle: 'solid',
    borderWidth: '5px 0 5px 6px',
    borderColor: 'transparent transparent transparent var(--workbench-tooltip)',
  },
};
 ...
 * // Simple usage
 * html`
 * <workbench-tooltip>Content</workbench-tooltip>
 * `
 * // With placement
 * html`
 ...
 *   .autoFlip=${true}
 *   .arrow=${true}
 *   .tooltipStyle=${css`:host { z-index: 0; --workbench-tooltip: #fff; }`}
 ...
 * ```
 */
@customElement('workbench-tooltip')
export class Tooltip extends LitElement {
  ...
  accessor zIndex: number | string = 'var(--workbench-z-index-popover)';
        ...
        return {
          template: ({ positionSlot, updatePortal }) => {
            ...
            return html`
              ...
              <div class="workbench-tooltip" role="tooltip">${children}</div>
