import { isEqual, sha } from '@maxiee/block_global/utils';
      ...
      switch (o.node.tagName) {
        ...
        case 'th': {
          ...
          const columnType = Array.isArray(columnTypeClass)
            ...
            : 'rich-text';
          context.pushGlobalContextStack<BlockkitTableColumn>(
            'hast:table:column',
            {
              type: columnType,
        ...
        case 'tr': {
          if (
            ...
            const columns =
              context.getGlobalContextStack<BlockkitTableColumn>(
                'hast:table:column'
              );
    ...
    walker.setLeave((o, context) => {
      ...
      switch (o.node.tagName) {
        ...
        case 'table': {
          ...
          context
            .getGlobalContextStack<BlockkitTableRow>('hast:table:rows')
            .map((row, i) => {
