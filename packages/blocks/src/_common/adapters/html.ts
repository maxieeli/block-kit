import { sha } from '@maxiee/block_global/utils';
...
import { ASTWalker, BaseAdapter } from '@maxiee/block_store';
...
export class HtmlAdapter extends BaseAdapter<Html> {
      ...
      switch (o.node.flavour) {
        case 'workbench:page': {
          context
            ...
            .openNode({
              type: 'comment',
              value: 'BlockKitDocTitlePlaceholder',
            })
            .closeNode();
          break;
        }
                ...
                .openNode(
                  {
                    ...
                    tagName: 'div',
                    properties: {
                      className: ['workbench-paragraph-block-container'],
                    },
                    children: [],
                  },
                  'children'
                ...
                .openNode(
                  {
                    ...
                    tagName: 'div',
                    properties: {
                      className: ['workbench-block-children-container'],
            ...
            .openNode(
              {
                ...
                tagName: 'div',
                properties: {
                  className: ['workbench-list-block-container'],
                },
                children: [],
              },
              'children'
            ...
            .openNode(
              {
                ...
                tagName: 'figure',
                properties: {
                  className: ['workbench-image-block-container'],
                },
                children: [],
              },
              'children'
              ...
              .openNode(
                {
                  type: 'block',
                  id: nanoid(),
                  flavour: 'workbench:embed-youtube',
                  props: {
  ...
  private _deltaToHast = (deltas: DeltaInsert<WorkbenchTextAttributes>[]) => {
