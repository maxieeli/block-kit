...
export const DATABASE_CONVERT_WHITE_LIST = ['workbench:list', 'workbench:paragraph'];
...
export class DatabaseConvertView extends WithDisposable(LitElement) {
  static override styles = css`
    ...
    .modal-view-item-content:hover svg {
      fill: var(--workbench-primary-color);
    ...
    .modal-view-item-icon svg {
      width: 42px;
      height: 42px;
      fill: var(--workbench-black-50);
    }
    .modal-view-item-text {
      font-size: 14px;
      color: var(--workbench-black-50);
    }
