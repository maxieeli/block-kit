...
import type { BlockElement, TextSelection } from '@maxiee/block-std';
import { getInlineRangeProvider } from '@maxiee/block-std';
import { assertExists } from '@maxiee/block_global/utils';
import type { InlineRangeProvider } from '@maxiee/block_inline';
...
@customElement('workbench-paragraph')
...
> {
  ...
  override get topContenteditableElement() {
    if (this.rootElement instanceof EdgelessRootBlockComponent) {
      const el = this.closest<BlockElement>(
        'workbench-note, workbench-edgeless-text'
      );
      return el;
    }
  ...
  @query('.workbench-paragraph-placeholder')
  ...
  private _isInDatabase = () => {
    ...
    while (parent && parent !== document.body) {
      if (parent.tagName.toLowerCase() === 'workbench-database') {
        return true;
      }
  ...
  override renderBlock(): TemplateResult<1> {
    ...
    return html`
      <div class="workbench-paragraph-block-container">
        <div class="workbench-paragraph-rich-text-wrapper ${type}">
          <rich-text
          ...
          ${this.inEdgelessText
            ...
            : html`
                <div
                  ...
                  class="workbench-paragraph-placeholder"
                >
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-paragraph': ParagraphBlockComponent;
  }
}
