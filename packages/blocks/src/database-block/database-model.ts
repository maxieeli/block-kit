import type { MigrationRunner, Text } from '@maxiee/block_store';
import { BlockModel, defineBlockSchema, nanoid } from '@maxiee/block_store';
...
export const DatabaseBlockSchema = defineBlockSchema({
  ...
  metadata: {
    ...
    children: ['workbench:paragraph', 'workbench:list'],
  },
