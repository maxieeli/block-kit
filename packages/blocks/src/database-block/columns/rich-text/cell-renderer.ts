...
@customElement('workbench-database-rich-text-cell')
export class RichTextCell extends BaseCellRenderer<Text> {
  static override styles = css`
    workbench-database-rich-text-cell {
      display: flex;
      align-items: center;
      width: 100%;
      user-select: none;
    ...
    .workbench-database-rich-text v-line {
    ...
    .workbench-database-rich-text v-line > div {
      flex-grow: 1;
    }
  `;
  ...
  get service() {
    return this.view
      ...
      ?.std.spec.getService('workbench:database');
  }
  ...
  override render() {
    ...
    if (!this.value) {
      return html`<div class="workbench-database-rich-text"></div>`;
    }
    return keyed(
      this.value,
      html`<rich-text
        ...
        .readonly=${true}
        class="workbench-database-rich-text inline-editor"
      ></rich-text>`
    );
  }
}

@customElement('workbench-database-rich-text-cell-editing')
export class RichTextCellEditing extends BaseCellRenderer<Text> {
  ...
  static override styles = css`
    workbench-database-rich-text-cell-editing {
      display: flex;
      align-items: center;
      width: 100%;
      min-width: 1px;
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-database-rich-text-cell-editing': RichTextCellEditing;
  }
}
