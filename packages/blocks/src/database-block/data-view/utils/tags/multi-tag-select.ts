...
import { nanoid } from '@maxiee/block_store';
...
@customElement('workbench-multi-tag-select')
export class MultiTagSelect extends WithDisposable(ShadowlessElement) {
  ...
  override render() {
    ...
    return html`
      <div class="workbench-select-cell-select">
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-multi-tag-select': MultiTagSelect;
  }
}
