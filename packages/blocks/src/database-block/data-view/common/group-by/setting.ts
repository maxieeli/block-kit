  ...
  protected override render(): unknown {
    ...
    return html`
      <div style="padding: 7px 12px;">
        <div
          style="padding: 0 4px; font-size: 12px;color: var(--workbench-text-secondary-color);line-height: 20px;"
        >
          Groups
        </div>
        <div></div>
          ...
          children: () => [
            {
              ...
              postfix: html`
                <div
                  style="display:flex;align-items:center;gap: 4px;font-size: 12px;line-height: 20px;color: var(--workbench-text-secondary-color);margin-right: 4px;margin-left: 8px;"
                  class="dv-icon-16"
                >
                  ${renderUniLit(icon, {})}
