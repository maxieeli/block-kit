...
const styles = css`
  ...
  .workbench-data-view-kanban-groups {
    position: relative;
    z-index: 1;
    display: flex;
    gap: 20px;
  ...
  .workbench-data-view-kanban-groups:hover {
    padding-bottom: 0px;
  }

  .workbench-data-view-kanban-groups::-webkit-scrollbar {
    -webkit-appearance: none;
    display: block;
  }

  .workbench-data-view-kanban-groups::-webkit-scrollbar:horizontal {
    height: 4px;
  }

  .workbench-data-view-kanban-groups::-webkit-scrollbar-thumb {
    border-radius: 2px;
    background-color: transparent;
  }

  .workbench-data-view-kanban-groups:hover::-webkit-scrollbar:horizontal {
    height: 8px;
  }

  .workbench-data-view-kanban-groups:hover::-webkit-scrollbar-thumb {
    border-radius: 16px;
    background-color: var(--workbench-black-30);
  }

  .workbench-data-view-kanban-groups:hover::-webkit-scrollbar-track {
...
@customElement('workbench-data-view-kanban')
...
> {
  ...
  @query('.workbench-data-view-kanban-groups')
  ...
  override firstUpdated() {
    const sortable = Sortable.create(this.groups, {
      ...
      handle: '.group-header',
      draggable: 'workbench-data-view-kanban-group',
      animation: 100,
      onEnd: evt => {
        if (evt.item instanceof KanbanGroup) {
          const groups = Array.from(
            this.groups.querySelectorAll('workbench-data-view-kanban-group')
          );
  ...
  override render() {
    ...
    return html`
      ...
      <div class="workbench-data-view-kanban-groups" @wheel="${this.onWheel}">
        ${repeat(
          groups,
          group => group.key,
          group => {
            return html` <workbench-data-view-kanban-group
              data-key="${group.key}"
              .dataViewEle="${this.dataViewEle}"
              .view="${this.view}"
              .group="${group}"
            ></workbench-data-view-kanban-group>`;
          }
        )}
        ${this.renderAddGroup()}
      </div>
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-data-view-kanban': DataViewKanban;
  }
}
