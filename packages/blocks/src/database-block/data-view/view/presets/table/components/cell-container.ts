...
@customElement('workbench-database-cell-container')
export class DatabaseCellContainer extends WithDisposable(ShadowlessElement) {
  ...
  static override styles = css`
    ...
    workbench-database-cell-container uni-lit > *:first-child {
      padding: 8px;
    }
  `;
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-database-cell-container': DatabaseCellContainer;
  }
}
