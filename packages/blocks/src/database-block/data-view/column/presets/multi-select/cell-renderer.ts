...
@customElement('workbench-database-multi-select-cell')
...
@customElement('workbench-database-multi-select-cell-editing')
  ...
  private popTagSelect = () => {
    this._disposables.add({
      dispose: popTagSelect(
        this.querySelector('workbench-multi-tag-view') ?? this,
        {
