...
@customElement('workbench-data-view-renderer')
export class DataViewRenderer extends WithDisposable(ShadowlessElement) {
  ...
  static override styles = css`
    ${unsafeCSS(dataViewCommonStyle('workbench-data-view-renderer'))}
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-data-view-renderer': DataViewRenderer;
  }
}
...
export class DataView {
  ...
  render(props: DataViewRendererConfig) {
    return html` <workbench-data-view-renderer
      ${ref(this._ref)}
      .config="${props}"
    ></workbench-data-view-renderer>`;
  }
