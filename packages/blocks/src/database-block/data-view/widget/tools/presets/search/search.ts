...
const styles = css`
  .workbench-database-search-container {
    position: relative;
    display: flex;
    align-items: center;
    gap: 8px;
  ...
  .workbench-database-search-container svg {
    width: 20px;
    height: 20px;
  ...
  .workbench-database-search-input-icon {
    position: absolute;
    left: 0;
    height: 100%;
    display: flex;
  ...
  .workbench-database-search-input-icon:hover {
    background: var(--workbench-hover-color);
  }

  .search-container-expand .workbench-database-search-input-icon {
    left: 4px;
    pointer-events: none;
  }

  .workbench-database-search-input {
    flex: 1;
    width: 100%;
  ...
  .workbench-database-search-input::placeholder {
...
export class DataViewHeaderToolsSearch extends WidgetBase {
  ...
  @query('.workbench-database-search-input')
  ...
  override render() {
    const searchToolClassMap = classMap({
      'workbench-database-search-container': true,
      'search-container-expand': this.showSearch,
    });
    return html`
      <label class="${searchToolClassMap}" @click="${this._clickSearch}">
        <div class="workbench-database-search-input-icon dv-icon-20">
          ${DatabaseSearchIcon}
        </div>
        <input
          placeholder="Search..."
          class="workbench-database-search-input"
