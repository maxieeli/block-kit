...
@customElement('workbench-embed-linked-doc-block')
@Peekable()
...
> {
  ...
  @queryAsync('.workbench-embed-linked-doc-banner.render')
  accessor bannerContainer!: Promise<HTMLDivElement>;

  @queryAsync('.workbench-embed-linked-doc-content-note.render')
  ...
  override renderBlock() {
    ...
    return this.renderEmbed(
      () => html`
        <div>
          <div
            class="workbench-embed-linked-doc-block ${cardClassMap}"
            @click=${this._handleClick}
            @dblclick=${this._handleDoubleClick}
          >
            <div class="workbench-embed-linked-doc-content">
              <div class="workbench-embed-linked-doc-content-title">
                <div class="workbench-embed-linked-doc-content-title-icon">
                  ${titleIcon}
                </div>

                <div class="workbench-embed-linked-doc-content-title-text">
                  ${titleText}
                </div>
              </div>

              <div class="workbench-embed-linked-doc-content-note render"></div>
              ${showDefaultNoteContent
                ? html`<div
                    class="workbench-embed-linked-doc-content-note default"
                  >
                    ${defaultNoteContent}
                  </div>`
                : nothing}

              <div class="workbench-embed-linked-doc-content-date">
                <span>Updated</span>
            ...
            <div class="workbench-embed-linked-doc-banner render"></div>

            ${showDefaultBanner
              ? html`
                  <div class="workbench-embed-linked-doc-banner default">
                    ${defaultBanner}
                  </div>
                `
              : nothing}
            <div class="workbench-embed-linked-doc-block-overlay"></div>
          </div>
        </div>
      `
    );
