...
export const styles = css`
  ...
  .workbench-embed-html img,
  .workbench-embed-html object,
  .workbench-embed-html svg {
    width: 100%;
    height: 100%;
    object-fit: cover;
  ...
  .workbench-embed-html-iframe-container {
    position: relative;
    width: 100%;
    height: 100%;
  ...
  .embed-html-block-iframe-wrapper workbench-menu {
    min-width: 296px;
  }

  .embed-html-block-iframe-wrapper workbench-menu .settings-header {
    padding: 7px 12px;
    font-weight: 500;
  ...
  .workbench-embed-html-iframe-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .workbench-embed-html-iframe-overlay.hide {
    display: none;
  }

  .workbench-embed-html-title {
    display: flex;
    align-items: center;
    gap: 8px;
  ...
  .workbench-embed-html-title-icon {
    display: flex;
    width: 20px;
    height: 20px;
  ...
  .workbench-embed-html-title-icon img,
  .workbench-embed-html-title-icon object,
  .workbench-embed-html-title-icon svg {
    width: 20px;
    height: 20px;
    fill: var(--workbench-background-primary-color);
  }

  .workbench-embed-html-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
