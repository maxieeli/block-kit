...
@customElement('workbench-embed-html-block')
...
> {
  ...
  override renderBlock(): unknown {
    ...
    return this.renderEmbed(() => {
      if (!this.model.html) {
        return html` <div class="workbench-html-empty">Empty</div>`;
      }
      return html`
        <div
          class=${classMap({
            'workbench-embed-html-block': true,
        ...
        >
          <div class="workbench-embed-html">
            <div class="workbench-embed-html-iframe-container">
              ...
              <div
                class=${classMap({
                  'workbench-embed-html-iframe-overlay': true,
          ...
          <div class="workbench-embed-html-title">
            <div class="workbench-embed-html-title-icon">${HtmlIcon}</div>

            <div class="workbench-embed-html-title-text">${titleText}</div>
          </div>
        </div>
      `;
    });
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-embed-html-block': EmbedHtmlBlockComponent;
  }
}
