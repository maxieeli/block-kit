...
@customElement('workbench-page-image')
export class ImageBlockPageComponent extends WithDisposable(ShadowlessElement) {
  ...
  static override styles = css`
    ...
    workbench-page-image .resizable-img {
      position: relative;
      max-width: 100%;
    }

    workbench-page-image .resizable-img img {
      width: 100%;
      height: 100%;
    }
  `;
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-page-image': ImageBlockPageComponent;
  }
}
