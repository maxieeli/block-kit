...
@customElement('workbench-attachment')
...
> {
  ...
  get edgeless() {
    ...
    return this.host.querySelector('workbench-edgeless-root');
  }
  ...
  override renderBlock() {
    ...
    return html`
      <div
        ...
        class="workbench-attachment-container"
        style=${containerStyleMap}
      >
        ${embedView
          ? html`<div
              class="workbench-attachment-embed-container"
            ...
            >
              ...
              <div
                class=${classMap({
                  'workbench-attachment-iframe-overlay': true,
          ...
          : html`<div
              class=${classMap({
                'workbench-attachment-card': true,
                [cardStyle]: true,
              ...
              @dblclick=${this._handleDoubleClick}
            >
              <div class="workbench-attachment-content">
                <div class="workbench-attachment-content-title">
                  <div class="workbench-attachment-content-title-icon">
                    ${titleIcon}
                  </div>

                  <div class="workbench-attachment-content-title-text">
                    ${titleText}
                  </div>
                </div>

                <div class="workbench-attachment-content-info">${infoText}</div>
              </div>

              <div class="workbench-attachment-banner">${FileTypeIcon}</div>
            </div>`}
      </div>
    `;
  }
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-attachment': AttachmentBlockComponent;
  }
}
