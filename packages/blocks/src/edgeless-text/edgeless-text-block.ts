...
export class EdgelessTextBlockComponent extends BlockElement<EdgelessTextBlockModel> {
  ...
  @query('.workbench-block-children-container')
  ...
  override renderBlock() {
    ...
    return html`
      <div style=${style} class="workbench-edgeless-text-block-container">
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-edgeless-text': EdgelessTextBlockComponent;
  }
}
