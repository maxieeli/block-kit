...
export const styles = css`
  ...
  .workbench-embed-github-content {
  ...
  .workbench-embed-github-content-title {
    display: flex;
    min-height: 22px;
    flex-direction: row;
    gap: 8px;
  ...
  .workbench-embed-github-content-title-icons {
    display: flex;
  ...
  .workbench-embed-github-content-title-icons img,
  .workbench-embed-github-content-title-icons object,
  .workbench-embed-github-content-title-icons svg {
    width: 16px;
    height: 16px;
    color: var(--workbench-pure-white);
  }

  .workbench-embed-github-content-title-site-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
    ...
    .github-icon {
      fill: var(--workbench-black);
      color: var(--workbench-black);
    }
  }

  .workbench-embed-github-content-title-status-icon {
    display: flex;
    align-items: center;
    gap: 4px;
    padding: 3px 6px;
  ...
  .workbench-embed-github-content-title-status-icon.issue.open {
    background: #238636;
  }
  .workbench-embed-github-content-title-status-icon.issue.closed.success {
    background: #8957e5;
  }
  .workbench-embed-github-content-title-status-icon.issue.closed.failure {
    background: #6e7681;
  }
  .workbench-embed-github-content-title-status-icon.pr.open {
    background: #238636;
  }
  .workbench-embed-github-content-title-status-icon.pr.draft {
    background: #6e7681;
  }
  .workbench-embed-github-content-title-status-icon.pr.merged {
    background: #8957e5;
  }
  .workbench-embed-github-content-title-status-icon.pr.closed {
    background: #c03737;
  }

  .workbench-embed-github-content-title-status-icon > svg {
    height: 16px;
    width: 16px;
    padding: 2px;
  }

  .workbench-embed-github-content-title-status-icon > span {
    padding: 0px 1.5px;
  }

  .workbench-embed-github-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .workbench-embed-github-content-description {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
  ...
  .workbench-embed-github-content-assignees {
    display: none;
  }

  .workbench-embed-github-content-url {
    display: flex;
    align-items: center;
  ...
  .workbench-embed-github-content-url > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .workbench-embed-github-content-url:hover > span {
    color: var(--workbench-link-color);
  }
  .workbench-embed-github-content-url:hover .open-icon {
    fill: var(--workbench-link-color);
  }

  .workbench-embed-github-content-url-icon {
    display: flex;
    align-items: center;
    justify-content: center;
    width: 12px;
  ...
  .workbench-embed-github-content-url-icon .open-icon {
    height: 12px;
    width: 12px;
    fill: var(--workbench-text-secondary-color);
  }

  .workbench-embed-github-banner {
  ...
  .workbench-embed-github-banner img,
  .workbench-embed-github-banner object,
  .workbench-embed-github-banner svg {
    width: 204px;
    max-width: 100%;
    height: 102px;
    object-fit: cover;
  ...
  .workbench-embed-github-block.loading {
    .workbench-embed-github-content-title-text {
      color: var(--workbench-placeholder-color);
    }
  }

  .workbench-embed-github-block.selected {
    .workbench-embed-github-content-url > span {
      color: var(--workbench-link-color);
    }
    .workbench-embed-github-content-url .open-icon {
      fill: var(--workbench-link-color);
    }
  }

  .workbench-embed-github-block.list {
    ...
    .workbench-embed-github-content-repo {
      display: none;
    }

    .workbench-embed-github-content-date {
      display: none;
    }
  ...
  .workbench-embed-github-block.vertical {
    ...
    .workbench-embed-github-content-assignees-text {
      display: -webkit-box;
      -webkit-line-clamp: 1;
      -webkit-box-orient: vertical;
    ...
    .workbench-embed-github-content-assignees-text.label {
      width: 72px;
      color: var(--workbench-text-primary-color);
      font-weight: 600;
    }

    .workbench-embed-github-content-assignees-text.users {
      width: calc(100% - 72px);
      word-break: break-all;
      white-space: normal;
      overflow: hidden;
    ...
    .workbench-embed-github-content-assignees-text-users.user {
      color: var(--workbench-link-color);
      cursor: pointer;
    }

    .workbench-embed-github-content-assignees-text-users.placeholder {
      color: var(--workbench-placeholder-color);
    }
  ...
  .workbench-embed-github-block.cube {
