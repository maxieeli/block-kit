...
export const blockStyles = css`
  .edgeless-block-portal-embed
    > workbench-embed-synced-doc-block[data-nested-editor] {
    position: relative;
    display: block;
    left: 0px;
    top: 0px;
  ...
  .edgeless-block-portal-embed
    .workbench-embed-synced-doc-editor
    .workbench-page-root-block-container {
    width: 100%;
  }

  .edgeless-block-portal-embed .workbench-embed-synced-doc-container.edgeless {
    display: block;
    padding: 0;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .edgeless-block-portal-embed .workbench-embed-synced-doc-container.surface {
    border: 1px solid var(--workbench-border-color);
  }

  workbench-embed-synced-doc-block[data-nested-editor]
    .workbench-embed-synced-doc-container.page {
    padding: 0 24px;
  }

  .workbench-embed-synced-doc-container {
    border-radius: 8px;
    overflow: hidden;
  }
  .workbench-embed-synced-doc-container.page {
  ...
  .workbench-embed-synced-doc-container.edgeless {
    display: block;
    width: 100%;
    height: calc(${EMBED_CARD_HEIGHT.syncedDoc}px + 36px);
  }
  .workbench-embed-synced-doc-container:hover.light {
    box-shadow: 0px 0px 0px 2px rgba(0, 0, 0, 0.08);
  }
  .workbench-embed-synced-doc-container:hover.dark {
    box-shadow: 0px 0px 0px 2px rgba(255, 255, 255, 0.14);
  }
  .workbench-embed-synced-doc-header-wrapper {
    position: absolute;
    top: 0;
    left: 0;
    height: 34px;
    width: 100%;
    background-color: var(--workbench-white);
    opacity: 0;
  }
  .workbench-embed-synced-doc-header-wrapper.selected {
    opacity: 1;
    transition: all 0.23s ease;
  }
  .workbench-embed-synced-doc-header {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .workbench-embed-synced-doc-header svg {
    flex-shrink: 0;
  }
  .workbench-embed-synced-doc-title {
    font-size: 14px;
    font-weight: 600;
    line-height: 22px;
    margin-left: 8px;
  ...
  .workbench-embed-synced-doc-editor-overlay {
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
  ...
  .workbench-embed-synced-doc-editor-overlay:hover {
    background: var(--workbench-hover-color);
  }

  .workbench-embed-synced-doc-editor-empty {
    display: flex;
    align-items: center;
    width: 100%;
    height: 100%;
  ...
  .workbench-embed-synced-doc-container.surface
    > .workbench-embed-synced-doc-editor
    > .workbench-embed-synced-doc-editor-empty {
    left: 0;
  ...
  .workbench-embed-synced-doc-editor-empty > span {
  ...
  .workbench-embed-synced-doc-container
    > .workbench-embed-synced-doc-editor.workbench-page-viewport {
    background: transparent;
  }

  .workbench-embed-synced-doc-container > .workbench-embed-synced-doc-editor {
    width: 100%;
    height: 100%;
  }

  .workbench-embed-synced-doc-editor .workbench-page-root-block-container {
    width: 100%;
    max-width: 100%;
  }
`;
...
export const cardStyles = css`
  .workbench-embed-synced-doc-card {
    margin: 0 auto;
  ...
  .workbench-embed-synced-doc-card-content {
  ...
  .workbench-embed-synced-doc-card-content-title {
    display: flex;
    flex-direction: row;
    gap: 8px;
    align-items: center;
  ...
  .workbench-embed-synced-doc-card-content-title-icon {
    display: flex;
    width: 16px;
    height: 16px;
    justify-content: center;
  ...
  .workbench-embed-synced-doc-card-content-title-icon svg {
    width: 16px;
    height: 16px;
    fill: var(--workbench-background-primary-color);
  }

  .workbench-embed-synced-doc-card-content-title-text {
    display: -webkit-box;
    -webkit-line-clamp: 1;
  ...
  .workbench-embed-synced-doc-content-note.render {
    display: none;
    overflow: hidden;
    pointer-events: none;
  }
  ...
  .workbench-embed-synced-doc-content-note.default {
    display: -webkit-box;
    -webkit-line-clamp: 2;
    -webkit-box-orient: vertical;
    white-space: normal;
  ...
  .workbench-embed-synced-doc-card-content-date,
  .workbench-embed-synced-doc-card-content-reload {
    display: flex;
    flex-grow: 1;
  ...
  .workbench-embed-synced-doc-card-content-date > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
  ...
  .workbench-embed-synced-doc-card-content-reload-button {
    display: flex;
    flex-direction: row;
    align-items: center;
    gap: 4px;
  ...
  .workbench-embed-synced-doc-card-content-reload-button svg {
    width: 12px;
    height: 12px;
    fill: var(--workbench-background-primary-color);
  }
  .workbench-embed-synced-doc-card-content-reload-button > span {
    display: -webkit-box;
    -webkit-line-clamp: 1;
    -webkit-box-orient: vertical;
    word-break: break-all;
    ...
    overflow: hidden;
    text-overflow: ellipsis;
    color: var(--workbench-brand-color);
    font-family: var(--workbench-font-family);
    font-size: var(--workbench-font-xs);
    font-style: normal;
    font-weight: 500;
  ...
  .workbench-embed-synced-doc-card-banner {
  ...
  .workbench-embed-synced-doc-card-banner.render {
    display: none;
  }
  .workbench-embed-synced-doc-card-banner img,
  .workbench-embed-synced-doc-card-banner object,
  .workbench-embed-synced-doc-card-banner svg {
    width: 204px;
    max-width: 100%;
    height: 102px;
    object-fit: cover;
  ...
  .workbench-embed-synced-doc-card.loading,
  .workbench-embed-synced-doc-card.deleted,
  .workbench-embed-synced-doc-card.error {
    .workbench-embed-linked-doc-content-note.render {
      display: none;
    }
    .workbench-embed-linked-doc-content-note.default {
      display: block;
    }
    .workbench-embed-synced-doc-card-banner.render {
      display: none;
    }
    .workbench-embed-synced-doc-card-banner.default {
      display: block;
    }
    .workbench-embed-synced-doc-card-content-date {
      display: none;
  ...
  .workbench-embed-synced-doc-card:not(.loading).deleted,
  .workbench-embed-synced-doc-card:not(.loading).error {
    background: var(--workbench-background-secondary-color);
  }
  .workbench-embed-synced-doc-card:not(.loading):not(.error):not(
      .surface
    ).deleted {
  ...
  .workbench-embed-synced-doc-card:not(.loading):not(.error):not(.deleted):not(
      .note-empty
    ).cycle {
    .workbench-embed-synced-doc-content-note.render {
      display: block;
  ...
  .workbench-embed-synced-doc-card.surface:not(.cycle) {
    ...
    .workbench-embed-synced-doc-card-content-note {
      margin: 0 auto;
      flex-grow: 0;
    }
  ...
  .workbench-embed-synced-doc-card.surface:not(.loading):not(.error):not(
      .deleted
    ).cycle {
