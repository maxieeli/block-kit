...
@customElement('workbench-embed-synced-doc-card')
export class EmbedSyncedDocCard extends WithDisposable(ShadowlessElement) {
  ...
  @queryAsync('.workbench-embed-synced-doc-card-banner.render')
  accessor bannerContainer!: Promise<HTMLDivElement>;

  @queryAsync('.workbench-embed-synced-doc-content-note.render')
  ...
  override render() {
    ...
    return html`
      <div
        class="workbench-embed-synced-doc-card ${cardClassMap}"
        @click=${this._handleClick}
      >
        <div class="workbench-embed-synced-doc-card-content">
          <div class="workbench-embed-synced-doc-card-content-title">
            <div class="workbench-embed-synced-doc-card-content-title-icon">
              ${titleIcon}
            </div>

            <div class="workbench-embed-synced-doc-card-content-title-text">
              ${titleText}
            </div>
          </div>

          ${showDefaultNoteContent
            ? html`<div class="workbench-embed-synced-doc-content-note default">
                ${defaultNoteContent}
              </div>`
            : nothing}
          <div class="workbench-embed-synced-doc-content-note render"></div>

          ${error
            ? html`
                <div class="workbench-embed-synced-doc-card-content-reload">
                  <div
                    class="workbench-embed-synced-doc-card-content-reload-button"
              ...
              `
            : html`
                <div class="workbench-embed-synced-doc-card-content-date">
                  <span>Updated</span>
        ...
        <div class="workbench-embed-synced-doc-card-banner render"></div>

        ${showDefaultBanner
          ? html`
              <div class="workbench-embed-synced-doc-card-banner default">
                ${defaultBanner}
              </div>
            `
          : nothing}
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-embed-synced-doc-card': EmbedSyncedDocCard;
  }
}
