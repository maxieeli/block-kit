...
@customElement('workbench-embed-youtube-block')
    ...
    return this.renderEmbed(
      () => html`
        <div>
          <div
            class=${classMap({
              'workbench-embed-youtube-block': true,
              loading,
          ...
          >
            <div class="workbench-embed-youtube-video">
              ${videoId
                ? html`
                    <div class="workbench-embed-youtube-video-iframe-container">
                      <iframe
                        id="ytplayer"
                        type="text/html"
                      ...
                      <div
                        class=${classMap({
                          'workbench-embed-youtube-video-iframe-overlay': true,
            ...
            <div class="workbench-embed-youtube-content">
              <div class="workbench-embed-youtube-content-header">
                <div class="workbench-embed-youtube-content-title-icon">
                  ${titleIcon}
                </div>

                <div class="workbench-embed-youtube-content-title-text">
                  ${titleText}
                </div>

                <div class="workbench-embed-youtube-content-creator-image">
                  ${creatorImageEl}
                </div>

                <div class="workbench-embed-youtube-content-creator-text">
                  ${creator}
                </div>
              </div>

              <div class="workbench-embed-youtube-content-description">
                ${descriptionText}
              </div>

              <div class="workbench-embed-youtube-content-url" @click=${this.open}>
                <span>www.youtube.com</span>

                <div class="workbench-embed-youtube-content-url-icon">
                  ${OpenIcon}
                </div>
              </div>
            </div>
...
declare global {
  interface HTMLElementTagNameMap {
    'workbench-embed-youtube-block': EmbedYoutubeBlockComponent;
  }
}
