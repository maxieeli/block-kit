  ...
  switch (model.type) {
    case 'bulleted':
      return html`<div
        ...
        class="workbench-list-block__prefix"
        @click=${onClick}
      >
    ...
    case 'numbered':
      return html`<div
        contenteditable="false"
        class="workbench-list-block__prefix workbench-list-block__numbered"
        @click=${onClick}
      >
    ...
    case 'todo':
      return html`<div
        contenteditable="false"
        class="workbench-list-block__prefix workbench-list-block__todo-prefix"
        @click=${onClick}
      >
